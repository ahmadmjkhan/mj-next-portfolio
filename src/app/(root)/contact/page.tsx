    ...
    <>
      <section className="max-width section-padding">
        <div className="box text-center flex flex-col items-center gap-3">
          ...
          <h2 className="text-grey-700">I'd Love to Hear You</h2>
        ...
        <div className="tablet:max-w-md w-full">
          <div className="space-y-4">
            <div className="box !p-6">
              <p className="text-grey-600">You Can Email Here</p>
              <h6 className="text-grey-700">email@gmail.com</h6>
            </div>
            <div className="box !p-6">
              <p className="text-grey-600">Give Me a Call On</p>
              <h6 className="text-grey-700">12435557</h6>
            </div>
            <div className="box !p-6">
              <p className="text-grey-600">Location</p>
              <h6 className="text-grey-700">Lorem Strreeet</h6>
            </div>
          </div>
